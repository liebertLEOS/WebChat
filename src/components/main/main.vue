	...
	<div class="webchat-main" v-on:click.stop="statusMenu = false">
		...
		<div class="webchat-main-info">
			...
			<div class="webchat-status">
				<span class="webchat-ico" v-bind:class="{'webchat-status-offline': status==0,'webchat-status-online': status==1}" v-on:click.stop="statusMenu = true"></span>
...
.webchat-status-online:before{content: "\f111";}
.webchat-status-offline{color:#dd691d}
.webchat-status-offline:before{content: "\f017";}
...
.webchat-remark:focus{border: 1px solid #d2d2d2;border-color:#ccc;}
